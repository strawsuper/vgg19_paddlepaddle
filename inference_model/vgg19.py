### generated by caffe2fluid, your net is in class "VGG_ILSVRC_19_layers" ###
...
class VGG_ILSVRC_19_layers(Network):
    ...
    custom_layers_path = "/home/todd/caffe2fluid/kaffe"
    ...
    def custom_layer_factory(self):
        ...
        location = VGG_ILSVRC_19_layers.custom_layers_path
        pk_dir = os.path.join(VGG_ILSVRC_19_layers.custom_layers_path, pk_name)
        pk_paths.append((location, pk_dir))
    ...
    def setup(self):
        ...
        self.conv(3, 3, 512, 1, 1, padding=[1, 1], name='conv4_4')
        ...
        self.conv(3, 3, 512, 1, 1, padding=[1, 1], name='conv5_4')
...
def main():
    ...
    ret = VGG_ILSVRC_19_layers.convert(npy_weight, fluid_model, outputs)
    if ret == 0:
